...
(* DONE: TODO: Call explode with your name as input.  If you are working in a team, call
...
(* DONE: TODO: Call to_one_string with the result(s) of your call(s) to explode. *)
...
(* DONE: TODO: Call reverse with the result(s) of your call(s) to explode. *)
reverse(exp_name);;
...
(* DONE: TODO: Complete (and uncomment) the below recursive function to determine whether
...
(* DONE: TODO: Write 8 test cases to test your prefix function thoroughly. *)
...
(* DONE: TODO: Complete (and uncomment) the below function to determine whether
...
(* DONE: TODO: Write 8 test cases to test your suffix function thorougly. *)
(* These 4 should be true *)
...
(* DONE: TODO: Write 8 test cases to test your substring function thoroughly. *)
(* These 4 should be true *)
...
(* DONE: TODO: Write a comment to explain what map does. *)
...
(* DONE: TODO: Write a comment to explain what filter does. *)
...
(* DONE: TODO: Write a comment to explain what my_fold_left does. *)
...
(* DONE: TODO: Write a test case for flatten with your full name and your partner's name.
...
(* DONE: TODO: Complete (and uncomment) the following function call to produce ordered
...
(* DONE: TODO: Write a test case for cartesian_product with your full name and your
...
(* DONE: TODO: Call cartesian_product_better with the same test case for cartesian_product. *)
...
(* DONE: TODO: Write two test cases for concatenate: one which does not produce
...
(* DONE: TODO: Write a comment to tell what sorting algorithm is implemented by the
...
(* DONE: TODO: Complete (and uncomment) the below recursive function that removes
...
(* DONE: TODO: Uncomment the below code. *)
let concatenate_no_dupes xs ys gt =
  remove_dupes (sort (concatenate xs ys) gt);;

(* DONE: TODO: Call concatenate_no_dupes with the two test cases that you developed for
   concatenate. *)
...
(* DONE: TODO: Complete (and uncomment) the following two calls to add_all_to_sorted_list.
...
(* DONE: TODO: Call add_all_to_sorted_list using your two test cases from above, but use <
   instead of > . *)
...
(* DONE: TODO: Uncomment the following call to sorted_list_diff. *)
...
(* DONE: TODO: Uncomment the following call to sorted_list_diff_better. *)
...
(* DONE: TODO: Complete (and uncomment) the following two functions. *)
...
let directly_nullable rules = map get_LHS (filter is_nullable rules);;

(* DONE: TODO: Uncomment the following code. *)
...
let one_element_list = ["A"];;
let three_element_list = ["A";"B";"C"];;
let six_element_list = ["A";"B";"C";"D";"E";"F"];;
let empty_list = [];;
...
(* I am using version 1.2.0 of ocaml-top. This line will prevent the rest of the file from being run because version 1.2.0 will stop at a warning. Uncomment this code to run it*)
(*let tail (h::t) = t;;

  (* DONE: TODO: Call tail twice: once on a list with a single element and once on a list with
  at least two elements.  What happens when you try to call tail on an empty list?
  Write your answer a comment. *)
  tail one_element_list;;
  tail three_element_list;;
  (*tail empty_list;;*) (* There is no condition to handle an empty list so it will crash *) 
*)
...
let cons x ys = x::ys;;
(* DONE: TODO: Call cons twice with nested function calls to add two items to an empty list. *)
cons "item 1" (cons "item 2" []);;
...
(* TODO: Call power_set on the empty list, a list with a single item, and a list with
   6 items. *)
power_set empty_list;;
power_set one_element_list;;
power_set six_element_list;;
...
(* DONE: TODO: the last one.  Yay!!!!! Develop a CFG with lambda rules that generates
   {(first)^m (last)^m (last)^n (first)^n | m, n >= 0}, assuming first
   represents your first name, and last represents your last name.  Do this
   for each team member. *)
let jeffreysimpson_cfg = [('S', "AB");('A',"jeffreyAsimpson");('A',"jeffreysimpson");('B',"simpsonBjeffrey");('B',"simpsonjeffrey")];;
explode_all_RHS jeffreysimpson_cfg;;
make_clean_essentially_noncontracting_grammar 'S' jeffreysimpson_cfg;;
